...
<body>
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-header">
            <img src="app/assets/img/logo-definitivo 2.jpg" alt="Logo" class="logo">
        </div>
    ...
    <div class="auth-buttons">
        <a href="app/views/auth/login.php" class="btn-login">Iniciar Sesión</a>
        <a href="app/views/auth/signup.php" class="btn-register">Registrarse</a>
    </div>
        ...
        <section id="donaciones" class="section">
            ...
            <div class="donaciones-container">
                ...
                <div class="metodos-donacion">
                    ...
                    <div class="metodo-donacion">
                        <img src="app/assets/img/mercadopago.png" alt="MercadoPago">
                        <button class="btn-donar">Donar con MercadoPago</button>
                    </div>
                </div>
            </div>
        </section>
